...
4. G: فقط نام ۳ تا ۶ بازی واقعی و متناسب با سخت‌افزار را با ویرگول بنویس؛ هیچ توضیحی درباره تنظیمات یا سطح اجرا ننویس.
5. SW: نام نرم‌افزارهای واقعی و مناسب را کوتاه بنویس. اگر سخت‌افزار توان دارد حتماً Adobe Photoshop و Adobe Illustrator را ذکر کن.
