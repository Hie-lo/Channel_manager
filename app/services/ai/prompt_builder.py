...
2. F1 تا F12: ده تا دوازده ویژگی خاص و برجسته محصول (هر کدام ۴ تا ۸ کلمه)
   - مشخصات فنی مهم
   - قابلیت‌های کلیدی
   - نقاط قوت سخت‌افزاری
   - ویژگی‌های منحصربه‌فرد
   
3. N1, N2: دو محدودیت یا کاستی واقعی این نوع محصول (هر کدام ۳ تا ۶ کلمه)
...
وظیفه: متن فروشنده رو بهبود بده و ۱۰-۱۲ ویژگی فنی برجسته اضافه کن.

قوانین دقیق:
1. D: بازنویسی جامع‌تر متن فروشنده (۲ تا ۳ جمله)
2. F1 تا F12: ده تا دوازده ویژگی خاص بر اساس مشخصات (هر کدام ۴ تا ۸ کلمه)
