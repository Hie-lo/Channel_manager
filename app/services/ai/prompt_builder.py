...
4. SW: نام نرم‌افزارهای واقعی و مناسب را کوتاه بنویس مثل Adobe Photoshop و Adobe Illustrator هیچ توضیحی درباره تنظیمات یا سطح اجرا ننویس
...
5. SW: نام نرم‌افزارهای واقعی؛ در صورت توان سخت‌افزار حتماً Photoshop و Illustrator را بررسی کن، نیازی نیست ذکر کنی
6. F1 تا F6: فقط ۳ تا ۶ نقطه قوت کوتاه، خودمانی و قانع‌کننده بنویس. مشخصات خام و آپشن‌های چاپ‌شده را تکرار نکن؛ فایده واقعی برای خریدار را بگو. لحن طبیعی و کمی هیجان‌دار باشد و هر بار جمله‌بندی متفاوتی داشته باشد، بدون اغراق دروغین.
