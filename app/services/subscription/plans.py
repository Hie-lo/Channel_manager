...
PLANS: dict[str, PlanFeatures] = {
    "BRONZE": PlanFeatures(
        ...
        price_quarterly=400_000,
        price_half_yearly=750_000,
    ),
    "SILVER": PlanFeatures(
        key="SILVER",
        name_fa="نقره‌ای",
        ...
        price_quarterly=800_000,
        price_half_yearly=1_500_000,
    ),
    "GOLD": PlanFeatures(
        key="GOLD",
        name_fa="طلایی",
        ...
        price_quarterly=1_300_000,
        price_half_yearly=2_500_000,
    ),
}
