...
SCREEN_ALIASES = ["صفحه نمایش", "نمایشگر", "screen", "display", "mon", "monitor","Resolution"]
...
VGA_PORT_ALIASES = ["پورت وی جی ای", "vga", "vga port", "vga out","VGA"]  # ⚠️ عمداً alias «vga» خام نداره؛ اون برای gpu رزرو شده
